...
void main() {
  ...
  group('PasswordService', () {
    ...
    test('resetPasswordWithPasskey works correctly', () async {
      ...
      final isReset = await PasswordService.resetPasswordWithPasskey(
        passkey,
        newPassword,
      );
    ...
    test('getPasswordCreationDate returns creation date', () async {
      ...
      final storedCreationDate =
          await PasswordService.getPasswordCreationDate();
      expect(storedCreationDate, isNotNull);
      expect(
        storedCreationDate!.isBefore(DateTime.now().add(Duration(seconds: 1))),
        isTrue,
      );
    });
    ...
    group('Edge cases', () {
      ...
      test('handles special characters in password', () async {
        ...
        final isVerified = await PasswordService.verifyPassword(
          specialPassword,
        );
        expect(isVerified, isTrue);
      });
